...
public:
	...
	// Returns pointers of compounds (or nullptr) with the specified unique keys.
	[[nodiscard]] std::vector<const CCompound*> GetCompounds(const std::vector<std::string>& _keys) const;
