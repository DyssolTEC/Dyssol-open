...
class COptionsEditor : public QDialog
{
	...
	CFlowsheetParameters* m_pParams;	// pointer to the flowsheet parameters
...
public:
	COptionsEditor(CFlowsheet* _pFlowsheet, CMaterialsDatabase* _pMaterialsDB, QWidget* parent = nullptr, Qt::WindowFlags flags = 0);
