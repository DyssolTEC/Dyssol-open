...
{
	enum class EArgType { argDOUBLE, argUNSIGNED, argSTRING, argSTRINGS, argGRIDS, argUNITS, argHLDP_DISTRS, argHLDP_COMPS, argHLDP_SOLIDS, argEXPORT_MASS };
	struct SArgument
	{
...
private:
	...
	SExportMass ExportMassFromSS(std::stringstream& _ss) const;
	void ClearArguments();
